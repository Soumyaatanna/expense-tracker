...
# Use BigAutoField by default (recommended for modern Django projects)
...
# Local development convenience: if no SMTP is configured, print emails to console
if DEBUG and not EMAIL_HOST:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    # ensure DEFAULT_FROM_EMAIL has a fallback
